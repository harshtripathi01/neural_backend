...
module.exports = {
    SUBJECT: " neural OTP Confirmation",
    ACTIVATION_TEMPLATE: `
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="x_card-row"
                                                                    ...
                                                                    us - please use the below mentioned OTP to complete
                                                                    your onboarding verification.</td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td class="x_card-row"
                                                                    style="font-family:Helvetica,Arial,sans-serif; font-size:16px; line-height:24px; word-break:break-word; padding-left:20px; padding-right:20px; padding-top:20px; margin-left:px; margin-right:px">
                                                                    Access the world of neural - where highly skilled
                                                                    experts get matched with innovative projects!</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="x_card-row"
                                                                    style="font-family:Helvetica,Arial,sans-serif; font-size:16px; line-height:24px; word-break:break-word; padding-left:20px; padding-right:20px; padding-top:20px; margin-left:px; margin-right:px">
