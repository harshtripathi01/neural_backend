                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="x_card-row"
                                                                    style="font-family:Helvetica,Arial,sans-serif; font-size:16px; line-height:24px; word-break:break-word; padding-left:20px; padding-right:20px; padding-top:20px; margin-left:px; margin-right:px">
                                                                    Your security is our top priority, and this OTP
                                                                    ensures a secure authentication process for your
                                                                    account creation. If you encounter any issues or
                                                                    need further assistance, feel free to reach out to
                                                                    our support team.</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="x_card-row"
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div class="x_button-holder"
                                                                                        ...
                                                                                        <a style="background-color:#073d95; border:2px solid #073d95; border-radius:10px; min-width:230px; color:#FFFFFF; white-space:nowrap; font-weight:normal; display:block; font-family:Helvetica,Arial,sans-serif; font-size:24px; line-height:40px; text-align:center; text-decoration:none"
                                                            ...
                                                            <tr>
                                                                <!-- <td class="x_card-row"
																	...
																	accepted. We will
																	notify you of our
																	decision by email within 24 hours. </td> -->
                                                            </tr>
                                                            <tr>
                                                                <td class="x_card-row"
                            ...
                            <tr>
                                <td align="center" width="100%"
                                    ...
                                    <div class="x_address-link"
                                        ...
                                        E-1, 9/100, Sector - 3, Rajendra Nagar, Sahibabad, Ghaziabad, U.P.- 201005
                                    </div>
                                    <div
                                        style="font-family: Helvetica, Arial, sans-serif, serif, EmojiFont; word-break: normal;">
