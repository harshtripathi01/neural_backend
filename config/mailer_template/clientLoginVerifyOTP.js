...
module.exports = {
    SUBJECT: "TalenCred OTP Confirmation",
    ACTIVATION_CLIENT_TEMPLATE: `
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="x_card-row"
                                                                    style="font-family:Helvetica,Arial,sans-serif; font-size:16px; line-height:24px; word-break:break-word; padding-left:20px; padding-right:20px; padding-top:20px; margin-left:px; margin-right:px">
                                                                    Welcome aboard TalenCred!</td>
                                                            </tr>

                                                            <tr>
                                                                <td class="x_card-row"
                                                                    style="font-family:Helvetica,Arial,sans-serif; font-size:16px; line-height:24px; word-break:break-word; padding-left:20px; padding-right:20px; padding-top:20px; margin-left:px; margin-right:px">
                                                                    Your security is our top priority. To ensure a
                                                                    seamless onboarding process, please use the OTP
                                                                    provided below to complete your verification:</td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td class="x_card-row"
                                                                    style="font-family:Helvetica,Arial,sans-serif; font-size:16px; line-height:24px; word-break:break-word; padding-left:20px; padding-right:20px; padding-top:20px; margin-left:px; margin-right:px">
                                                                    Once verified, you'll gain access to the vibrant
                                                                    community of TalenCred, where visionary clients like
                                                                    you connect with highly skilled experts to drive
                                                                    forward groundbreaking projects.</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="x_card-row"
                                                                    style="font-family:Helvetica,Arial,sans-serif; font-size:16px; line-height:24px; word-break:break-word; padding-left:20px; padding-right:20px; padding-top:20px; margin-left:px; margin-right:px">
                                                                    Thank you for choosing TalenCred. We're excited to
                                                                    partner with you on your journey to success!</td>
                                                            </tr>
